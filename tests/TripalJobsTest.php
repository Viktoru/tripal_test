...
class TripalJobsTest extends PHPUnit_Framework_TestCase {
  ...
  public function testTest() {
    $this->assertTrue(TRUE, "This test failed");
  } 
  ...
  public function test_tripal_add_job() {
    ...
    $this->assertTrue($test_job_id == $job_id, 'Could not find job that was just added.');

    // TODO: the remaining tests fail beccause the tripal_add_job() function needs fixes
